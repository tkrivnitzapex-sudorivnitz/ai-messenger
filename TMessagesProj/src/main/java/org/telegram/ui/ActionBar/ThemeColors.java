...
public class ThemeColors {
    ...
    public static final int TELEGRAM_COLOR = 0xFF3B82F6;        // -12877066
    public static final int TELEGRAM_COLOR_TEXT = 0xFF2F6FDE;   // -13668386
    ...
    public static int[] createDefaultColors() {
        ...
        defaultColors[key_dialogLinkSelection] = 0x333b82f6;
        ...
        defaultColors[key_dialogTextHint] = 0xff9ca3af;
        defaultColors[key_dialogIcon] = DEFAULT_BLACK_TEXT;
        defaultColors[key_dialogGrayLine] = 0xffe5e7eb;
        ...
        defaultColors[key_dialogSearchHint] = 0xff9ca3af;
        ...
        defaultColors[key_gift_ribbon] = TELEGRAM_COLOR;
        ...
        defaultColors[key_windowBackgroundWhiteBlueIcon] = TELEGRAM_COLOR;
        ...
        defaultColors[key_windowBackgroundWhiteHintText] = 0xff9ca3af;
        ...
        defaultColors[key_windowBackgroundWhiteLinkSelection] = 0x333b82f6;
        ...
        defaultColors[key_actionBarDefaultSubtitle] = 0xff9ca3af;       // key_windowBackgroundWhiteGrayText
        ...
        defaultColors[key_table_border] = 0xffE5E7EB;
        ...
        defaultColors[key_chats_sentCheck] = TELEGRAM_COLOR;
        defaultColors[key_chats_sentReadCheck] = TELEGRAM_COLOR;
        defaultColors[key_chats_sentClock] = 0xff9ca3af;
        defaultColors[key_chats_sentError] = 0xffd55252;
        defaultColors[key_chats_sentErrorIcon] = 0xffffffff;
        defaultColors[key_chats_verifiedBackground] = TELEGRAM_COLOR;
        ...
        defaultColors[key_chats_menuItemCheck] = TELEGRAM_COLOR;
        ...
        defaultColors[key_chats_actionPressedBackground] = 0xff2f6fde;
        defaultColors[key_chats_menuTopBackgroundCats] = TELEGRAM_COLOR;
        ...
        defaultColors[key_chat_attachGalleryBackground] = TELEGRAM_COLOR;
        ...
        defaultColors[key_chat_inBubbleSelected] = 0xffeef3fe;
        defaultColors[key_chat_inBubbleShadow] = 0xff1d3753;
        defaultColors[key_chat_outBubble] = TELEGRAM_COLOR;
        defaultColors[key_chat_outBubbleGradientSelectedOverlay] = 0x14000000;
        defaultColors[key_chat_outBubbleSelected] = 0xff2f6fde;
        defaultColors[key_chat_outBubbleShadow] = 0xff1e40af;
        defaultColors[key_chat_inMediaIcon] = 0xffffffff;
        defaultColors[key_chat_inMediaIconSelected] = 0xffeef3fe;
        defaultColors[key_chat_outMediaIcon] = TELEGRAM_COLOR;
        defaultColors[key_chat_outMediaIconSelected] = 0xff2f6fde;
        defaultColors[key_chat_messageTextIn] = 0xff111827;
        defaultColors[key_chat_messageTextOut] = 0xffffffff;
        defaultColors[key_chat_messageLinkIn] = TELEGRAM_COLOR_TEXT;
        defaultColors[key_chat_messageLinkOut] = 0xffffffff;
        ...
        defaultColors[key_chat_outSentCheck] = 0xffffffff;
        defaultColors[key_chat_outSentCheckSelected] = 0xffffffff;
        defaultColors[key_chat_outSentCheckRead] = 0xffffffff;
        defaultColors[key_chat_outSentCheckReadSelected] = 0xffffffff;
        defaultColors[key_chat_outSentClock] = 0xccffffff;
        defaultColors[key_chat_outSentClockSelected] = 0xccffffff;
        ...
        defaultColors[key_chat_outViews] = 0xccffffff;
        defaultColors[key_chat_outViewsSelected] = 0xccffffff;
        ...
        defaultColors[key_chat_outMenu] = 0xccffffff;
        defaultColors[key_chat_outMenuSelected] = 0xccffffff;
        defaultColors[key_chat_mediaMenu] = 0xffffffff;
        defaultColors[key_chat_outInstant] = 0xffffffff;
        defaultColors[key_chat_outInstantSelected] = 0xccffffff;
        defaultColors[key_chat_inInstant] = TELEGRAM_COLOR_TEXT;
        defaultColors[key_chat_inInstantSelected] = 0xff2f6fde;
        defaultColors[key_chat_sentError] = 0xffdb3535;
        defaultColors[key_chat_sentErrorIcon] = 0xffffffff;
        defaultColors[key_chat_selectedBackground] = 0x283b82f6;
        ...
        defaultColors[key_chat_outPsaNameText] = 0xffffffff;
        ...
        defaultColors[key_chat_inReplyLine] = TELEGRAM_COLOR;
        defaultColors[key_chat_outReplyLine] = 0xffffffff;
        defaultColors[key_chat_outReplyLine2] = 0xffffffff;
        ...
        defaultColors[key_chat_inReplyMessageText] = 0xff111827;
        defaultColors[key_chat_outReplyMessageText] = 0xffffffff;
        defaultColors[key_chat_inReplyMediaMessageText] = 0xffa1aab3;
        defaultColors[key_chat_outReplyMediaMessageText] = 0xccffffff;
        defaultColors[key_chat_inReplyMediaMessageSelectedText] = 0xff89b4c1;
        defaultColors[key_chat_outReplyMediaMessageSelectedText] = 0xccffffff;
        ...
        defaultColors[key_chat_outContactPhoneText] = 0xffffffff;
        defaultColors[key_chat_outContactPhoneSelectedText] = 0xffffffff;
        defaultColors[key_chat_mediaProgress] = 0xffffffff;
        defaultColors[key_chat_inAudioProgress] = 0xffffffff;
        defaultColors[key_chat_outAudioProgress] = TELEGRAM_COLOR;
        defaultColors[key_chat_inAudioSelectedProgress] = 0xffeef3fe;
        defaultColors[key_chat_outAudioSelectedProgress] = 0xff2f6fde;
        ...
        defaultColors[key_chat_outAdminText] = 0xccffffff;
        defaultColors[key_chat_outAdminSelectedText] = 0xccffffff;
        defaultColors[key_chat_inTimeText] = 0xffa1aab3;
        defaultColors[key_chat_inTimeSelectedText] = 0xff89b4c1;
        defaultColors[key_chat_outTimeText] = 0xccffffff;
        defaultColors[key_chat_outTimeSelectedText] = 0xccffffff;
        defaultColors[key_chat_inAudioPerformerText] = 0xff2f3438;
        defaultColors[key_chat_inAudioPerformerSelectedText] = 0xff2f3438;
        defaultColors[key_chat_outAudioPerformerText] = 0xffffffff;
        defaultColors[key_chat_outAudioPerformerSelectedText] = 0xffffffff;
        defaultColors[key_chat_inAudioTitleText] = TELEGRAM_COLOR_TEXT;
        defaultColors[key_chat_outAudioTitleText] = 0xffffffff;
        defaultColors[key_chat_inAudioDurationText] = 0xffa1aab3;
        defaultColors[key_chat_outAudioDurationText] = 0xccffffff;
        defaultColors[key_chat_inAudioDurationSelectedText] = 0xff89b4c1;
        defaultColors[key_chat_outAudioDurationSelectedText] = 0xccffffff;
        defaultColors[key_chat_inAudioSeekbar] = 0xffe4eaf0;
        defaultColors[key_chat_inAudioCacheSeekbar] = 0x3fe4eaf0;
        defaultColors[key_chat_outAudioSeekbar] = 0x66ffffff;
        defaultColors[key_chat_outAudioCacheSeekbar] = 0x3fffffff;
        defaultColors[key_chat_inAudioSeekbarSelected] = 0xffbcdee8;
        defaultColors[key_chat_outAudioSeekbarSelected] = 0x66ffffff;
        defaultColors[key_chat_inAudioSeekbarFill] = TELEGRAM_COLOR;
        defaultColors[key_chat_outAudioSeekbarFill] = 0xffffffff;
        defaultColors[key_chat_inVoiceSeekbar] = 0xffdee5eb;
        defaultColors[key_chat_outVoiceSeekbar] = 0x66ffffff;
        defaultColors[key_chat_inVoiceSeekbarSelected] = 0xffbcdee8;
        defaultColors[key_chat_outVoiceSeekbarSelected] = 0x66ffffff;
        defaultColors[key_chat_inVoiceSeekbarFill] = TELEGRAM_COLOR;
        defaultColors[key_chat_outVoiceSeekbarFill] = 0xffffffff;
        defaultColors[key_chat_inFileProgress] = 0xffebf0f5;
        defaultColors[key_chat_outFileProgress] = TELEGRAM_COLOR;
        defaultColors[key_chat_inFileProgressSelected] = 0xffd9e6fc;
        defaultColors[key_chat_outFileProgressSelected] = 0xff2f6fde;
        defaultColors[key_chat_inFileNameText] = TELEGRAM_COLOR_TEXT;
        defaultColors[key_chat_outFileNameText] = 0xffffffff;
        defaultColors[key_chat_inFileInfoText] = 0xffa1aab3;
        defaultColors[key_chat_outFileInfoText] = 0xccffffff;
        defaultColors[key_chat_inFileInfoSelectedText] = 0xff89b4c1;
        defaultColors[key_chat_outFileInfoSelectedText] = 0xccffffff;
        defaultColors[key_chat_inFileBackground] = 0xffebf0f5;
        defaultColors[key_chat_outFileBackground] = 0x33ffffff;
        defaultColors[key_chat_inFileBackgroundSelected] = 0xffd9e6fc;
        defaultColors[key_chat_outFileBackgroundSelected] = 0x4dffffff;
        defaultColors[key_chat_inVenueInfoText] = 0xffa1aab3;
        defaultColors[key_chat_outVenueInfoText] = 0xccffffff;
        defaultColors[key_chat_inVenueInfoSelectedText] = 0xff89b4c1;
        defaultColors[key_chat_outVenueInfoSelectedText] = 0xccffffff;
        defaultColors[key_chat_mediaInfoText] = 0xffffffff;
        defaultColors[key_chat_linkSelectBackground] = 0x333b82f6;
        defaultColors[key_chat_outLinkSelectBackground] = 0x40ffffff;
        defaultColors[key_chat_textSelectBackground] = 0x663b82f6;
        ...
        defaultColors[key_chat_emojiPanelStickerSetNameHighlight] = TELEGRAM_COLOR;
        ...
        defaultColors[key_chat_outLocationIcon] = 0xffffffff;
        ...
        defaultColors[key_chat_outContactIcon] = TELEGRAM_COLOR;
        ...
        defaultColors[key_chat_recordedVoiceBackground] = TELEGRAM_COLOR;
        defaultColors[key_chat_recordedVoiceDarkerBackground] = 0xff2F6FDE;
        defaultColors[key_chat_recordedVoiceProgress] = 0xffBFD7FC;
        defaultColors[key_chat_recordedVoiceProgressInner] = 0xffffffff;
        defaultColors[key_chat_recordVoiceCancel] = TELEGRAM_COLOR;
        ...
        defaultColors[key_chat_inlineResultIcon] = TELEGRAM_COLOR;
        ...
        defaultColors[key_chat_inLoaderSelected] = 0xff2f6fde;
        defaultColors[key_chat_outLoader] = 0xffffffff;
        defaultColors[key_chat_outLoaderSelected] = 0xffeef3fe;
        ...
        defaultColors[key_chat_inQuote] = TELEGRAM_COLOR;
        defaultColors[key_chat_outQuote] = 0xffffffff;

        defaultColors[key_profile_creatorIcon] = TELEGRAM_COLOR;
        ...
        defaultColors[key_files_folderIconBackground] = TELEGRAM_COLOR;
        ...
        defaultColors[key_passport_authorizeBackgroundSelected] = 0xff2f6fde;
        ...
        defaultColors[key_location_actionActiveIcon] = TELEGRAM_COLOR;
        ...
        defaultColors[key_featuredStickers_addButtonPressed] = 0xff2f6fde;
        ...
        defaultColors[key_groupcreate_hintText] = 0xff9ca3af;
        ...
        defaultColors[key_picker_enabledButton] = TELEGRAM_COLOR;
        ...
        defaultColors[key_chat_outTextSelectionHighlight] = 0x40ffffff;
        defaultColors[key_chat_inTextSelectionHighlight] = 0x503b82f6;
        defaultColors[key_chat_TextSelectionCursor] = TELEGRAM_COLOR;
        defaultColors[key_chat_outTextSelectionCursor] = 0xffffffff;
        defaultColors[key_chat_outBubbleLocationPlaceholder] = 0x1effffff;
        ...
        defaultColors[key_chat_outReactionButtonBackground] = 0xffffffff;
        ...
        defaultColors[key_chat_outReactionButtonTextSelected] = TELEGRAM_COLOR;
        ...
        defaultColors[key_chat_outCodeBackground] = 0x26000000;
